...
from roam.maptools.maptools import CaptureAction

class CopyTool(TouchMapTool):
    """
        Copy Tool which copies the feature to a new layer
	...
	#geomtype is now just being used to get an icon, but keep an eye out
