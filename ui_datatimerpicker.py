...
#
# Created: Wed Apr 18 15:03:57 2012
...
class Ui_datatimerpicker(object):
    def setupUi(self, datatimerpicker):
        ...
        datatimerpicker.resize(607, 352)
        ...
        self.ampmbutton.setMinimumSize(QtCore.QSize(0, 150))
        self.ampmbutton.setCheckable(True)
        self.ampmbutton.setObjectName(_fromUtf8("ampmbutton"))
        self.gridLayout.addWidget(self.ampmbutton, 2, 3, 1, 1)
